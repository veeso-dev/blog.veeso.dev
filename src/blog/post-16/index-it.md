...
Come amante di Rust, ho sempre sognato negli ultimi anni di poter lavorare con Rust a tempo pieno. Quando sono entrato in Prima nel 2021 ho avuto per la prima volta la possibilità di usare Rust a lavoro ed ero veramente contento, però purtroppo lo usavo solo per il 20-30% del tempo, insieme ad Elixir, Elm e <span style={{"text-decoration-line": "line-through"}}>sfortunatamente</span>, PHP.
