...
As a Rust enthusiast I've always dreamt in the last years to have a real full-time Rust job. When I joined Prima in 2021 I had the possibility to start using Rust at my workplace and I was so happy with that, but it was Rust at 30% I'd say, mixed with Elixir, Elm and <span style={{"text-decoration-line": "line-through"}}>unfortunately</span>, a lot of PHP.
...
![im-a-business-man](./imabusinessman.gif)
